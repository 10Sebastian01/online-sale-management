...
@section('content')
	<div class="card">
		...
		<div class="card-body table-responsive">
			<p>
				<a href="{{ route('admin.donhang.them') }}" class="btn btn-info"><i class="fal fa-plus"></i> Thêm mới</a>
			</p>
				...
				<tbody>
					@foreach($donhang as $value)
						<tr>
							...
							<td class="text-center"><a href="{{ route('admin.donhang.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có muốn xóa đơn hàng của khách {{ $value->NguoiDung->name }} không?')"><i class="fal fa-trash-alt text-danger"></i></a></td>
						</tr>
					@endforeach
				</tbody>
			</table>
